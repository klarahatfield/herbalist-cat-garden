...
const MONSTER_CODEX = [
  ...
  },
  {
    ...
    first:'몽환꽃밭 한 가운데에서 꽃잎들이 소용돌이치더니 거대한 형체를 만들어냈다. 예쁘긴 한데... 주먹이 엄청 아팠다.',
  ...
  // ── 가르릉숲 ──
  {
    id:'forest_troll',  zone:'forest',   loc:'가르릉숲',
    icon:'🌳', silhouette:'❓',
  ...
  {
    id:'shadow_wolf',   zone:'forest',   loc:'가르릉숲',
    icon:'🐺', silhouette:'❓',
  ...
  // ── 벨벳이끼언덕 ──
  {
    id:'moss_crab',     zone:'hills',    loc:'벨벳이끼언덕',
    icon:'🦀', silhouette:'❓',
  ...
  // ── 위스커정원 ──
  {
    id:'crystal_beetle', zone:'whisker', loc:'위스커정원',
    icon:'💎', silhouette:'❓',
  ...
  {
    id:'vine_horror',   zone:'whisker',  loc:'위스커정원',
    icon:'🌿', silhouette:'❓',
  ...
  // ── 스크래치전망대 ──
  {
    id:'wind_spirit',   zone:'lookout',  loc:'스크래치전망대',
    icon:'🌪️', silhouette:'❓',
    ...
    first:'스크래치전망대에서 바람이 거세지더니 모래가 소용돌이쳤다. 그 안에 뭔가 있었다.',
